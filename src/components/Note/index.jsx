...
import { Tag } from '../Tag'
import { Ratings, NegativeRatings } from '../Ratings'
...
export function Note({ data, ...rest}){
  ...
  { 
    ...
    console.log(starPositiveArray)
  }

  for( let i = 0; i < starNegative; i++)
  { 
    starNegativeArray.push(i)
    console.log(starNegativeArray)
  }
  ...
  return(
    ...
    <Container {...rest} >
      ...
      <header>
        ...
        { starPositiveArray.map(dat => <Ratings />) }
        { starNegativeArray.map(dat => <NegativeRatings />) }
